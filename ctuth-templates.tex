...
\ProvidesExplFile{ctuth-templates.tex}%
	{2016/06/15}{0.1 t1606152350}%MY TIMESTAMP HERE {0.1}
...
\ctutemplateset{twocolumn.abstract.in.secondlanguage}{
		...
		{\let\clearpage\relax\chapter*{\abstractname}\noindent
...
\ctutemplateset{maketitle.twocolumn.default}{
	% \begin{twocolumnfrontmatterpage} % hanetar commented out
	...
	% \newpage % hanetar commented out
		\ctutemplate{twocolumn.abstract.in.secondlanguage}
	\clearpage
% \end{twocolumnfrontmatterpage} % hanetar moved to here, commented out
	...
	% \end{twocolumnfrontmatterpage} % hanetar moved from here
}
